...
//        result.put("状态", person.getState());
        ...
        try {
            String JSONBody = HttpRequest.get("http://apis.baidu.com/apistore/idservice/id", true, "id", "440785199507153757").header("apikey", "f7acdb83732229dfc76297ed4ec14d42").body();
